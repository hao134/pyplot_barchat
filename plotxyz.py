...
data = {
    '時間段': ['時間一\n10/14(一)~\n10/15(二)', '時間一\n10/14(一)~\n10/15(二)', '時間一\n10/14(一)~\n10/15(二)', 
            '時間二\n10/17(四)~\n10/18(五)', '時間二\n10/17(四)~\n10/18(五)', '時間二\n10/17(四)~\n10/18(五)', 
            '時間三\n10/21(一)~\n10/22(二)', '時間三\n10/21(一)~\n10/22(二)', '時間三\n10/21(一)~\n10/22(二)'],
    '處': ['國勢普查處', '綜合統計處', '地方統計推展中心', '國勢普查處', '綜合統計處', '地方統計推展中心', '國勢普查處', '綜合統計處', '地方統計推展中心'],
    '人數': [9, 4, 1, 5, 0, 0, 3, 0, 0]
}
...
df_pivot = df_pivot[['國勢普查處', '綜合統計處', '地方統計推展中心']]

# 繪製堆積橫條圖
ax = df_pivot.plot(kind='barh', stacked=True, figsize=(10, 6), color=sns.color_palette("viridis", n_colors=3))
...
plt.title('使用T-SQL查詢資料 第一梯次課程開課時間詢問', fontsize=16, fontweight='bold')
...
# 添加箭頭和註記
ax.annotate('14', xy=(14, 0), xytext=(15, 0),
